...
var FLASH_WRITE_SIZE = 0x400;
var STUBLOADER_FLASH_WRITE_SIZE = 0x400;
var FLASH_SECTOR_SIZE = 0x400;  // Flash sector size, minimum unit of erase.
...
class EspStubLoader extends EspLoader {
  ...
  */
  constructor(params) {
    super(params);
    this.IS_STUB = true;
    if(!this._flash_size || (this._efuses[0] == 0 && this._efuses[1] == 0)){
    	console.log("detected stub");
    	this._efuses=params.efuses;
    	this._flash_size=params._flash_size;
    	if(!this._flash_size){
    		console.log("flash size empty, rescanning");
	    	this.chipName();
	    	this.getFlashID();
	    }
    }
