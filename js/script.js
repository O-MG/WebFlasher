...
function toggleUIConnected(connected) {
    ...
    if (connected) {
        ...
        lbl = "Error";
    	sdstat("error","hardware-missing");
        let err = "Either you did not select the CP2102 device, or we cannot connect to the device you selected. Click the Help button below below. Then refresh this page to attempt flashing again.";
